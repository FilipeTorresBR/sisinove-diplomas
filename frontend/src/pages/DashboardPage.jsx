...
export default function DashboardPage() {
  ...
  const cards = [['Total de diplomas', data.cards.totalDiplomas || 0], ['Registrados', data.cards.totalRegistered || 0], ['Enviados', data.cards.totalSent || 0], ['Entregues', data.cards.totalDelivered || 0], ['Em Confecção', data.cards.totalPending || 0]];
